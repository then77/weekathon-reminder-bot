export const hackatimeConfigs = {
	startWeeklyDate: '2026-08-16',
...
export const notificationMessages = {
	...
	special_reminder: [
		...
		"Psst {user}, school-day tomorrow energy is coming. Sneak in your code hours tonight before the bed claims you.",
	...
	user_not_found: [
		"Hey, i cant find your hackatime data with username {username}. What did you do? My reminder cant work properly without it."
	],
} as const;
